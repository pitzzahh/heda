	...
	export const alertVariants = tv({
		...
		variants: {
			variant: {
				...
				warning: 'text-yellow-600 border-yellow-600 [&>svg]:text-yellow-600 bg-yellow-600/10',
				valid: 'text-green-600 border-green-600 [&>svg]:text-green-600 bg-green-600/10',
				destructive:
